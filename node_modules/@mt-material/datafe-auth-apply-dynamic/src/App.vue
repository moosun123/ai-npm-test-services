...
export default class AuthApplyDynamic extends Vue {
  private userId = 0;
  ...
  get runtimeParams() {
    // 临时修复魔数错误的系统传参，魔数侧修复完后下线该逻辑(https://ones.sankuai.com/ones/product/2637/workItem/task/detail/62937880?activeTabName=first)
    if (this.params.system === 'MOSHU') {
      return {
        ...this.params,
        system: 'moshu'
      };
  ...
  get viewModal() {
    if (this.value) {
      ...
      const { system } = this.runtimeParams;
