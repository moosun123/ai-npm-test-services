...
exports.updateLibInfo = void 0;
const path = __importStar(require("path"));
const components_manage_tools_1 = require("@ss/components-manage-tools");
const chalk = require('chalk');
const inquirer = require('inquirer');
const updateLibInfo = async (libType) => {
    if (!libType) {
        (0, components_manage_tools_1.fatalLog)('update lib is must be have an libType(component or template).');
    }
    ...
    if (confirmUpdate === 'yes') {
        ...
        await (0, components_manage_tools_1.updateLibInfoApi)(updateParams, libType);
        console.log(chalk.green('update lib info success.'));
    }
    process.exit(0);
};
exports.updateLibInfo = updateLibInfo;
