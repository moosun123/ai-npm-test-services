...
var __vue_render__ = function __vue_render__() {
  var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('mtd-select', { ref: "select", attrs: { "loading": _vm.loading, "filterable": true, "remote": true, "remote-method": _vm.remoteMethod, "multiple": "", "reserve-keyword": _vm.reserveKeyword }, model: { value: _vm.value, callback: function callback($v) {
        _vm.value = $v;
    ...
    doTest: function doTest(done, _ref) {
      ...
      this.$nextTick(function () {
        ...
        setTimeout(function () {
          ...
          var option = document.body.querySelector('.mtd-select-dropdown .mtd-dropdown-menu-item');
