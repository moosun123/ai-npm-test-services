  ...
  <div :class="classes" @mousedown.prevent>
    <div :class="[panelPrefix + '-body', panelPrefix + '-multiple-body']">
      <div
        :class="[
          panelPrefix + '-content',
          panelPrefix + '-multiple-content',
          panelPrefix + '-content-left',
        ]"
      >
        ...
        <time-spinner
          ...
          :disabled-hours="disabledStart.disabledHours"
          :disabled-minutes="disabledStart.disabledMinutes"
          :disabled-seconds="disabledStart.disabledSeconds"
      ...
      >
        ...
        <time-spinner
          ...
          :disabled-hours="disabledEnd.disabledHours"
          :disabled-minutes="disabledEnd.disabledMinutes"
          :disabled-seconds="disabledEnd.disabledSeconds"
          :hide-disabled-options="hideDisabledOptions"
    ...
    <div :class="[panelPrefix + '-footer']">
      <Button ghost class="btn cancelbtn" @click="handleCancel">
        取消
      </Button>
...
export default {
  ...
  components: { TimeSpinner, Confirm, Button },
  ...
  watch: {
    ...
    dateStart (dateStart) {
      this.disabledStart = this.createDisabledHMS(dateStart);
    },
    dateEnd (dateEnd) {
      this.disabledEnd = this.createDisabledHMS(dateEnd);
    },

  },
  methods: {
    createDisabledHMS (time) {
      // 时
      ...
      const disabledMinutes = typeof this.disabledMinutes === 'function'
        ? this.disabledMinutes(time ? time.getHours() : undefined)
        : this.disabledMinutes;

      // 秒
      const disabledSeconds = typeof this.disabledSeconds === 'function'
        ? this.disabledSeconds(
          time ? time.getHours() : undefined,
          time ? time.getMinutes() : undefined)
        : this.disabledSeconds;
