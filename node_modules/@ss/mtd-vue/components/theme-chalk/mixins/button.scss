...
@mixin btn-color($color, $bgc, $borderColor,
  $hoverColor, $hoverBgc, $hoverBorderColor,
  $activeColor, $activeBgc, $activeBorderColor,
  $disabledColor, $disabledBgc, $disabledBorderColor,
  $disabledOpactiy) {
  color: $color;
  background: $bgc;
...
@mixin btn-text-color($color, $hoverColor, $hoverBgc, $activeColor, $activeBgc,
  $disabledColor, $disabledOpacity) {
  color: $color;
